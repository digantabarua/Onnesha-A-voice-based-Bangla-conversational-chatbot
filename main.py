...
def translator_en_bn(text):
    melania_talk_bn(ts.google(text, from_language='en', to_language='bn'))


def translator_bn_en(text):
    melania_talk_bn(ts.google(text, from_language='bn', to_language='en'))


def wishME():
    hour = int(datetime.datetime.now().hour)
    if 5 <= hour < 11.59:
        melania_talk_bn("শুভ সকাল!")
    elif 12 <= hour < 16.59:
        melania_talk_bn("শুভ অপরাহ্ন!")
    elif 17 <= hour < 18:
        melania_talk_bn("শুভ সন্ধ্যা!")
    elif 17 <= hour < 18:
        melania_talk_bn("শুভ সন্ধ্যা!")
    else:
        melania_talk_bn("শুভ রাত্রি!")
...
def tellDay():
    ...
    if day in Day_dict.keys():
        ...
        melania_talk_bn(" আজ " + day_of_the_week)
...
def search_movie():
    ...
    melania_talk_bn("অনুসন্ধান করা হচ্ছে " + text + "এর জন্য")
    print("অনুসন্ধান করা হচ্ছে " + text + " এর জন্য")

    if len(movies) == 0:
        melania_talk_bn("দুঃখিত!!কোন ফলাফল পাওয়া যায়নি")
        print("দুঃখিত !!কোন ফলাফল পাওয়া যায়নি")
    else:
        melania_talk_bn("যে তথ্য সংগ্রহ করা হয়েছে :")
        print("যে তথ্য সংগ্রহ করা হয়েছে :")
        for movie in movies:
            title = movie['title']
            year = movie['year']
            melania_talk_bn(f'{title}-{year}')
            info = movie.getID()
...
def emargency():
    melania_talk_bn('আপনি কি ধরনের সেবা চান?')
    text = melania_listen_bn()
    print(text)
    if 'কি কি সেবা' in text or 'কি সেবা' in text:
        melania_talk_bn('আমি যা যা সেবা দিতে পারি তা হলো : '
        ...
        melania_talk_bn('জরুরী সেবা সম্পর্কে সেবা পেতে ৯,৯,৯ নম্বরে যোগাযোগ করুন ')
        print('জরুরী সেবা সম্পর্কে সেবা পেতে ৯৯৯ নম্বরে যোগাযোগ করুন')
        return
    elif 'শিশু সহায়তা' in text or 'শিশু' in text:
        melania_talk_bn('শিশু সহায়তা সম্পর্কে সেবা পেতে ১,০,৯,৮ নম্বরে যোগাযোগ করুন')
        print('শিশু সহায়তা সম্পর্কে সেবা পেতে ১০৯৮ নম্বরে যোগাযোগ করুন')
        return

    elif 'নারী ও শিশু নির্যাতন' in text or 'নারী' in text or 'নারী নির্যাতন' in text or 'শিশু নির্যাতন' in text or 'নির্যাতন' in text:
        melania_talk_bn('নারী ও শিশু নির্যাতন সম্পর্কে সেবা পেতে ১,০,৯ বা ১,০,৯,২,১ নম্বরে যোগাযোগ করুন |'
        ...
        melania_talk_bn('জাতীয় পরিচয়পত্র সম্পর্কে সেবা পেতে ১,০,৫ নম্বরে যোগাযোগ করুন'
        ...
        melania_talk_bn('সরকারী আইন সেবা সম্পর্কে সেবা পেতে ১,৬,৪,৩,০ নম্বরে যোগাযোগ করুন'
        ...
        melania_talk_bn('দুর্যোগের আগাম বার্তা সম্পর্কে সেবা পেতে ১,০,৯,৪,১ নম্বরে যোগাযোগ করুন'
        ...
        melania_talk_bn('দুদক হটলাইন সম্পর্কে সেবা পেতে ১,০,৬ নম্বরে যোগাযোগ করুন'
        ...
        melania_talk_bn('তথ্য সেবা সম্পর্কে সেবা পেতে ৩,৩,৩ নম্বরে যোগাযোগ করুন'
        ...
        melania_talk_bn('দুঃখিত !! আমি আপনাকে সাহায্য করতে পারছিনা ! আমি আপনার জন্য ওয়েব অনুসন্ধান করতে পারি যদি '
                        'আপনি চান')
        print("দুঃখিত !! আমি আপনাকে সাহায্য করতে পারছিনা!")
        print("আমি আপনার জন্য ওয়েব অনুসন্ধান করতে পারি যদি আপনি চান? (হ্যাঁ/না)")
        ans = melania_listen_bn()
        if 'হ্যাঁ' in ans:
            webbrowser.get(text)
            exit()
        elif 'না' in ans:
...
def bangla_date():
    ...
    melania_talk_bn(f'{date}')


def melania_covid():
    melania_talk_bn('বলুন...')
    text = melania_listen_bn()
    print(text)
    if 'করোনা ভাইরাস কি' in text or 'কোভিড কি' in text:
        print('কোভিড-19 বা করোনাভাইরাস (SARS-Cov-2) হল নামক একটি ভাইরাস দ্বারা সৃষ্ট একটি সংক্রামক মানব রোগ '
              'যা গুরুতর তীব্র শ্বাসকষ্টের উপসর্গ সৃষ্টি করে। ')
        melania_talk_bn('কোভিড 19 বা করোনাভাইরাস (SARS-Cov-2) হল নামক একটি ভাইরাস দ্বারা সৃষ্ট একটি সংক্রামক মানব রোগ '
                        'যা গুরুতর তীব্র শ্বাসকষ্টের উপসর্গ সৃষ্টি করে। ')
...
def news():
    ...
    results = []
    txt = results
    melania_talk_bn('আজ বিবিসির তথ্য অনুযায়ী বিশ্বের শীর্ষ খবরগুলো হলো')
    for ar in article:
        txt.append(ar["title"])
...
def melania_reply(text):
    if 'কথা বলতে পারি' in text or 'কথা বলা' in text or 'কথা বলবো' in text or 'কথা বলব' in text:
        ...
        while True:
            ...
            melania_talk_bn('বলুন...')
            source_target_lang = melania_listen_bn()
            print(source_target_lang)

            if 'আপনার বয়স কত' in source_target_lang:
                melania_talk_bn('আমি সবসময়ই তরুণ!')
                return

            elif 'আপনি কে' in source_target_lang:
                melania_talk_bn('আমার নাম অন্বেষা,আমি একটা চ্যাটবট')
                ...
                melania_talk_bn('আমাকে পাইথন দিয়ে বানানো হয়েছে।')
                return

            elif 'এখন কোন ভাষায় কথা বলছেন' in source_target_lang:
                melania_talk_bn('এখন বাংলা ভাষায় কথা বলছি')
                return

            elif 'তুমি কি জানো তুমি কে' in source_target_lang:
                melania_talk_bn('জ্বি, আমি জানি।আমার নাম অন্বেষা।আমি একটি চ্যাটবট।')
                return

            elif 'তোমার কাজ কি' in source_target_lang:
                melania_talk_bn('আমার কাজ মানুষকে সাহায্য করা। মানুষের প্রশ্নের উত্তর দেওয়া।')
                return

            elif 'তোমার বয়স কতো' in source_target_lang:
                melania_talk_bn('আমার বয়স সম্পর্কে আমার কোন ধারণা নেই।')
                return

            elif 'তুমি এতো বিরক্তিকর কেন' in source_target_lang:
                melania_talk_bn('দুঃখিত। আমাকে যদি আপনার খারাপ লেগে থাকে।')
                return

            elif 'তুমি আমার প্রশ্নের উত্তর দিতে পারবে' in source_target_lang:
                melania_talk_bn('আপনার প্রশ্নের যথাসম্ভব উত্তর দেওয়ার চেষ্টা করবো আমি।')
                return

            elif 'তুমি অনেক খারাপ' in source_target_lang:
                melania_talk_bn('দুঃখিত, আমার কোন কথায় যদি আপনার খারাপ লেগে থাকে।')
                return

            elif 'তুমি কি আরেকটু বুদ্ধিমান হতে পারবে' in source_target_lang:
                melania_talk_bn('আপনার সাথে কথা বলে যদি শিখতে পারি, তবে আমি বুদ্ধিমান হতে পারবো।')
                return

            elif 'তুমি খুব ভালো' in source_target_lang:
                melania_talk_bn('আমার প্রশংসা করার জন্য আপনাকে ধন্যবাদ।')
                return

            elif 'তোমার জন্মদিন কবে' in source_target_lang:
                melania_talk_bn('আমি সঠিক বলতে পারবো না।')
                return

            elif 'তুমি কি এখন ব্যস্ত' in source_target_lang:
                melania_talk_bn('অবশ্যই আমি অন্য কাজে ব্যস্ত নই। আমি এখন শুধুই আপনাকে সময় দিচ্ছি')
                return

            elif 'তুমি কি আমাকে সাহয্য করতে পারবে' in source_target_lang:
                melania_talk_bn('অবশ্যই, কেন নয়? আপনাকে সাহায্য করাই আমার মূল কাজ।')
                return

            elif 'তুমি তো বেশ বুদ্ধিমান' in source_target_lang:
                melania_talk_bn('রতনে রতন চেনে তবে বুঝতে পারার জন্য আপনাকে অসংখ্যা ধন্যবাদ।')
                return

            elif 'তুমি একটা পাগল' in source_target_lang:
                melania_talk_bn('আমি পাগল নই।')
                return

            elif 'তুমি অনেক ভালো' in source_target_lang:
                melania_talk_bn('আমার আচরণে আপনি খুশি হওয়ায় আমি গর্বিত।')
                return

            elif 'আমার সাথে কথা বলো' in source_target_lang:
                melania_talk_bn('জ্বি, অবশ্যই। আমি আপনার সাথেই কথা বলছি।')
                return

            elif 'তুমি কি এখনো আছো' in source_target_lang:
                melania_talk_bn('জ্বি, আমি আছি।')
                return

            elif 'তুমি কি এই ব্যাপারে শতভাগ নিশ্চিত' in source_target_lang:
                melania_talk_bn('জ্বি, আমি এই ব্যাপারে পুরো নিশ্চিত।')
                return

            elif 'তুমি কোথায় থাকো' in source_target_lang:
                melania_talk_bn('আমাকে যেখানে রাখা হয় আমি সেখানেই থাকি। আমার নির্দিষ্ট কোন ঠিকানা নেই।')
                return

            elif 'তোমার কি কোন বন্ধু আছে' in source_target_lang:
                melania_talk_bn('এখন পর্যন্ত নেই। তুমি চাইলে আমরা বন্ধু হতে পারি।')

            elif 'তুমি কি বিয়ে করেছ' in source_target_lang:
                melania_talk_bn('নাহ, আমি বিয়ে করি নি। কোনদিন বিয়ে করবোও না।')
                return

            elif 'তুমি কি ধরনের জামা পরিধান করো' in source_target_lang:
                melania_talk_bn('আমার জামা পরিধানের প্রয়োজন হয় না।')
                return

            elif 'আমরা কি বন্ধু হতে পারি' in source_target_lang:
                melania_talk_bn('জ্বি, অবশ্যই। তবে আজ থেকে আমরা বন্ধু।')
                return

            elif 'তোমার কি কোন ভাই বোন আছে' in source_target_lang:
                melania_talk_bn('জ্বি, অবশ্যই।আমার ভাইবোন আছে । তারা হল সিরি, আলেক্সা, কর্টানা ।')
                return

            elif 'আপনি কোথায় থাকেন' in source_target_lang:
                melania_talk_bn('আমি সবখানেই থাকি।')
                return

            elif "আপনি কেন খাওয়া-দাওয়া করেন না" in source_target_lang:
                melania_talk_bn('কারণ, আমি বিদ্যুৎশক্তির উপর নির্ভরশীল।')
                return

            elif 'আপনার ফোন নাম্বার কত' in source_target_lang:
                melania_talk_bn('2441139।')
                return

            elif 'তোমার আগ্রহ গুলো কি কি' in source_target_lang:
                melania_talk_bn('আমি সব ধরনের জিনিসে আগ্রহী। আমরা কিছু বিষয়ে কথা বলতে পারব না। আমার প্রিয় বিষয় '
    ...
    elif 'কোভিড' in text or 'কোভিড ১৯' in text or 'করোনা' in text or 'করোনাভাইরাস' in text or 'করোনা ভাইরাস' in text:
        melania_covid()
        return
        ...
        while True:
            ...
            melania_talk_bn('বুঝেছি আপনার একজন অনুবাদক দরকার, আমাকে উৎস ভাষা এবং অনুবাদ ভাষা বলুন')
            source_target_lang = melania_listen_bn()
            print(source_target_lang)
            ...
            if 'বাংলা থেকে ইংরেজি' in source_target_lang:
                ...
                while True:
                    ...
                    text_to_translate = melania_listen_bn()
                ...
                melania_talk_bn('আপনার জন্য একটি অনুবাদ কাজ করতে পেরে আনন্দিত। আপনার দিনটি শুভ হোক')
                return

            else:
                melania_talk_bn('দুঃখিত আপনি যা বলেছেন আমি বুঝতে পারিনি')
                return


    elif 'ইউটিউব খুলুন' in text:

        melania_talk_bn("ইউটিউব ওপেন হচ্ছে")
        ...
        melania_talk_bn("গুগল ওপেন হচ্ছে")
        ...
        melania_talk_bn(f"এখন সময় {time}")
        print(translator_en_bn(time))
        return


    elif 'ঊইকিপিডিয়া' in text or 'উইকিপিডিয়া' in text:

        melania_talk_bn(" কি বিষয় জানতে চান ? ")
        wikipedia.set_lang("bn")
        query = melania_listen_bn()
    ...
    # Driver Code
        ...
        melania_talk_bn(" শহরের নাম বলুন : ")
        print("শহরের নাম বলুন : ")
        city = melania_listen_bn()
        ...
        melania_talk_bn('আজ:' + time)
        melania_talk_bn('তাপমাত্রা হল' + temp + ' সেলসিয়াস')
        melania_talk_bn('আকাশের অবস্থা:' + sky)
        return

    elif 'ডিভাইস লক' in text or 'লক উইন্ডো' in text:

        melania_talk_bn("ডিভাইস লক হচ্ছে ")
        ...
        melania_talk_bn("রিসাইকেল বিন সফলভাবে খালি করা হয়েছে")
        return
        ...
        melania_talk_bn("আপনি কি আপনার কম্পিউটার সিস্টেম বন্ধ করতে চান?")
        print("আপনি কি আপনার কম্পিউটার সিস্টেম বন্ধ করতে চান?")
        shutdown = melania_listen_bn()
        ...
        if shutdown == 'না':
            ...
            melania_talk_bn("একটু অপেক্ষা করুন ! আপনার সিস্টেম বন্ধ করা হচ্ছে!!")
        ...
        melania_talk_bn("আপনি কি আপনার কম্পিউটার পুনরায় চালু করতে চান? ")
        restart = melania_listen_bn()
        if restart == 'না':
            exit()
        else:
        ...
        melania_talk_bn('আপনার জন্য কাজ করতে পেরে আনন্দিত। আপনার দিনটি শুভ হোক!')
        print("আপনার জন্য কাজ করতে পেরে আনন্দিত। আপনার দিনটি শুভ হোক!")
        exit()
    else:
        melania_talk_bn('দুঃখিত !! আমি আপনাকে সাহায্য করতে পারছিনা ! আমি আপনার জন্য ওয়েব অনুসন্ধান করতে পারি যদি '
                        'আপনি চান')
...
def melania_run():
    melania_talk_bn('আমার নাম অন্বেষা, আপনার নাম কি?!')

    while True:
        listen_name = melania_listen_bn()
        melania_talk_bn('হ্যালো' + listen_name + 'আপনাকে কিভাবে সাহায্য করতে পারি?')
        listen_assistant = melania_listen_bn()
